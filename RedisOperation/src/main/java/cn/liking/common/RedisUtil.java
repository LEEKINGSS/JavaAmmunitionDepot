...
public class RedisUtil {
    ...
    public List<Object> getListThroughThePipeline(List<String> list) {
        final List<Object> resultList = redisTemplate.executePipelined((RedisCallback<Object>) connection -> {
    ...
    public List<Object> setListThroughThePipeline(String key, String value) {
     ...
     */
    public void pushTopicMessage(String topic, String msg) {
